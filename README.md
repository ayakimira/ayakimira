...
*   **Bode**: A Discord Rich Presence manager (based on [Kizzy](/dead8309/Kizzy)) for Android written in Kotlin. It uses the Discord Gateway to allow users to customize their presence with app and media detection, supporting Material You and background execution.
...
*   **Override** (bow-reborn): A reimagining of "Better Open With," acting as a custom replacement for the Android "Open with" dialog. It gives users fine-grained control over which apps handle specific file types and URLs.
